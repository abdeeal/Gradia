...
const Core = () => {
  return (
    <section id="features" className="w-full xl:h-dvh h-fit pt-16 xl:pt-0 flex flex-col items-center justify-center bg-white text-black pb-12">
      <p className="font-semibold text-[48px] pb-6">Core Features</p>
      <p className="-mt-2 text-center text-gray-600 px-6 xl:px-0">Built to Support Every Aspect of Your Academic Journey.</p>
