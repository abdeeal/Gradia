export const CourseCard = ({ start, end, title, alias, room, lecturer, sks, setDrawer}) => {
  ...
  return (
    <button onClick={openDrawer} className="md:w-[251px] h-full bg-background rounded-[8px] p-3 flex flex-col justify-between gap-2 group focus-within:border focus-within:border-border">
