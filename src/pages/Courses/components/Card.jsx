export const CourseCard = ({ start, end, title, alias, room, lecturer, sks }) => {

  const dotColor = sks == 3 ? "bg-red" : sks == 2 ? "bg-yellow" : "bg-blue";

  return (
    <div className="w-[251px] h-full bg-background rounded-[8px] p-3 flex flex-col justify-between gap-2">
