...
/* =========================
   1) REGISTER SUCCESS (tanpa perubahan UI)
========================= */
...
/* =========================
   2) RESET PASSWORD SUCCESS (tanpa perubahan UI)
========================= */
...
/* =========================
   3) WRAPPER: SuccessMsg
   - Menentukan komponen mana yang ditampilkan berdasar `type`
   - Mobile/tablet tetap pakai <Mobile type={type} />
========================= */

export default function SuccessMsg({ type }) {
  const isMobile = useMediaQuery({ maxWidth: 767 });
  const isTablet = useMediaQuery({ minWidth: 768, maxWidth: 1024 });

  if (isMobile || isTablet) {
    return <Mobile type={type} />;
  }

  // Desktop: pilih komponen berdasarkan type
  if (type === "register") return <RegisterSuccess />;
  if (type === "reset") return <ForgotSuccess />;

  // Kalau type tidak dikenali, tidak render apa-apa (bisa disesuaikan)
  return null;
}
