    ...
    <div className="relative h-screen w-screen overflow-hidden bg-black text-white">
      ...
      <div className="absolute inset-0 pointer-events-none select-none">
        <img src="/Asset 1.svg" alt="Asset 1" className="absolute z-0"
             style={{ width: vw(1410.82), height: vh(1185.82), left: vw(300.13), top: vh(-20), transform: "rotate(-360deg)", transformOrigin: "50% 50%", opacity: 0.9 }} />
      ...
      <div className="relative z-20 flex h-full flex-col items-center justify-center text-center">
        <div className="flex items-center justify-center gap-[0.5vw]" style={{ marginTop: vh(100) }}>
          <h1 className="font-extrabold leading-tight"
              style={{ fontFamily: "Inter, ui-sans-serif, system-ui", fontSize: vw(48), backgroundImage: "linear-gradient(180deg, #FAFAFA 0%, #949494 100%)", WebkitBackgroundClip: "text", color: "transparent", display: "inline-block" }}>
            Email Verified Successfully
          </h1>
          <i className="ri-checkbox-circle-fill" style={{ fontSize: vw(40), color: "#FAFAFA", marginTop: vh(2) }} />
        </div>

        <div style={{ height: GAP_TITLE_TO_P }} />

        <div style={{ width: vw(646) }}>
          <p style={{ fontFamily: "Inter, ui-sans-serif, system-ui", fontSize: vw(20), color: "#A3A3A3", lineHeight: 1.2 }}>
            Your email has been successfully verified.
            <br />You can now log in and continue managing your goals with Gradia.
          </p>
        </div>
        ...
        <a href="/auth/login" className="hover:underline"
           style={{ fontFamily: "Inter, ui-sans-serif, system-ui", fontSize: vw(16), width: vw(206.5), display: "inline-block" }}>
        ...
        <div className="flex items-center justify-center gap-[0.3vw]"
             style={{ fontFamily: "Inter, ui-sans-serif, system-ui", fontSize: vw(14), color: "#A3A3A3" }}>
...
export default function SuccessMsg({ type: typeProp }) {
  ...
  // Sumber penentuan tipe: prop -> state -> query -> default('register')
  const type = useMemo(() => {
