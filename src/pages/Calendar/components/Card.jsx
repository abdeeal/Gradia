...
const Card = ({ date, time, title, course, desc, priority, status, onClick, color}) => {
  return (
    <div onClick={onClick} className="bg-gradient-to-t from-[#141414] to-[#070707] rounded-[8px] px-2 py-5 flex flex-col gap-5 font-normal border border-border/50">
