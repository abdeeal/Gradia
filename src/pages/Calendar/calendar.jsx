...
export default function Calendar() {
  ...
  const SearchInHeader = (
    <div className="flex items-center gap-2">
      <svg width="18" height="18" viewBox="0 0 24 24" className="opacity-70">
        <path fill="currentColor" d="M15.5 14h-.79l-.28-.27a6.471 6.471 0 0 0 1.57-4.23A6.5 6.5 0 1 0 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79L20 21.49L21.49 20zM9.5 14A4.5 4.5 0 1 1 14 9.5A4.5 4.5 0 0 1 9.5 14" />
      </svg>
      <input
        type="text"
        placeholder="Search"
  ...
  return (
    <div className="flex"> {/* sidebar di kiri tanpa gap */}
        ...
        <div className="grid grid-cols-[753px_318px] gap-[20px] items-start">
          ...
          <div className="relative">
            <MonthCalendar
              ...
              /* Jika CalendarCard mendukung slot headerRight, pakai ini */
              headerRight={SearchInHeader}
            />

            {/* FALLBACK: kalau CalendarCard belum ada prop headerRight,
                kita tempel search secara absolut di kanan atas card */}
