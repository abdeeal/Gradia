...
export default function LoginPage() {
  ...
  const handleLogin = (e) => {
    e.preventDefault();
    // di sini nanti bisa tambahkan call API auth
    // kalau sukses:
    navigate("/dashboard");
  };
          ...
          <div>
            ...
            <form onSubmit={handleLogin}>
              ...
              <div className="flex justify-end mb-[10px]">
                <Link to="/login/forgot-input" className="text-[14px] hover:text-white">
                  Forgot Password?
                </Link>
              </div>
              ...
              <div className="flex items-center gap-4 mb-[14px]">
                ...
                <button
                  ...
                  // contoh: navigate ke OAuth page / nanti ganti ke handler asli
              ...
              <div className="text-center">
                <p className="text-[14px] mb-[48px]">
                  ...
                  <Link to="/register" className="hover:underline" style={{ color: "#643EB2" }}>
                    Register here
                  </Link>
                </p>
                <p className="text-[14px] leading-none">© 2025 Gradia. All rights reserved.</p>
              </div>
            </form>
          </div>
        </aside>
